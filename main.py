...
import cv2
import numpy as np
import pytesseract  as wewe

wewe.pytesseract.tesseract_cmd=r'C:\Users\Administrator\AppData\Local\Programs\Tesseract-OCR\tesseract.exe'
...
def extract_num(img_filename):
    ...
    for (x,y,w,h) in nplate:
        ...
        read=wewe.image_to_string(plate)
